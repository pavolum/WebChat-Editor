...
import { IAppState, WebChatStyleOption } from "../../Redux/reduxState";
    ...
    render() {
        ...
        return (
            <div>
                ...
                <PrimaryButton className={resetButtonClassName} onClick={(event: any) => {this.resetToDefault(event)}} text="Reset to default" />
            </div>
        );
    }
}
