...
export const ColorForm: React.FC<IColorFormProps> = (props: IColorFormProps) => {
    ...
    return (
        <div>
            <div>
                ...
                <SwatchColorPicker columnCount={5} cellShape={'square'} colorCells={accentColorOptions} onColorChanged={(id?, color?) => { props.updateStyleElement("accent", color) }} />
            </div>
            <div>
                <Label>Web Chat Background Color</Label>
                <SwatchColorPicker columnCount={5} cellShape={'square'} colorCells={chatBackgroundColorOptions} onColorChanged={(id?, color?) => { props.updateStyleElement("backgroundColor", color) }} />
            </div>
            <div>
                <Label>Bot Chat Bubble Background Color</Label>
                <SwatchColorPicker columnCount={5} cellShape={'square'} colorCells={chatBubbleBackgroundColorOptions} onColorChanged={(id?, color?) => { props.updateStyleElement("bubbleBackground", color) }} />
            </div>
            <div>
